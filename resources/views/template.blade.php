...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('assets/img/icons/brands/asana.png') }}" />
                ...
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        <span class="app-brand-logo demo">
                            <span class="app-brand-text demo menu-text fw-bolder ms-2">Indra RentCar</span>
                    </a>
                ...
                <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        <div class="d-flex">
                            ...
                            {{-- @if (Auth::guard('pengguna')->check())
                                <div class="text-kecil">
                                    Selamat Datang, {{ Auth::guard('pengguna')->user()->nama }}
                                </div>
                            @endif --}}
                        </div>
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    @if (Auth::guard('pengguna')->check())
                                                        <span
                                                            class="fw-semibold d-block text-kecil-pelanggan">{{ Auth::guard('pengguna')->user()->nama }}</span>
                                                        <small
                                                            class="text-muted">{{ Auth::guard('pengguna')->user()->username }}</small>
                                                    @endif
                                                </div>
                                            </div>
                                        </a>
